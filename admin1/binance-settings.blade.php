	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-lg-end">{{ __('general.currency') }} *</label>
                    <div class="col-sm-10">
                      <input value="{{ $data->crypto_currency }}" placeholder="BTC" name="crypto_currency" type="text" class="form-control">
                    </div>
                  </div>
